...
class Home extends React.Component {
    ...
    popArtists = ["arianagrande", "maroon5", "onerepublic", "coldplay", "katyperry"];
            ...
            <Col className="col-12 col-md-9 offset-md-3 mainPage">
                <Row>
                    <div className="col-9 col-lg-11 mainLinks d-none d-md-flex">
                        <div className="options">TRENDING</div>
                        <div className="options">PODCAST</div>
                        <div className="options">MOODS AND GENRES</div>
                        <div className="options">NEW RELEASES</div>
                        <div className="options">DISCOVER</div>
                    </div>
                </Row>
