                                ...
                                <ul>
                                    ...
                                    <li>
                                        <Link to="/favorites" className="nav-item nav-link">
                                            <i className="fas fa-book-open fa-lg"></i>&nbsp; Favourites
                                        </Link>
                                    </li>
                                        ...
                                        <li>
                                            <div className="input-group mt-3">
                                                ...
                                                <div className="input-group-append" style={{ marginBottom: "4%" }}>
                                                    <button className="btn btn-outline-secondary btn-sm" type="button" id="button-addon1" onClick={() => this.props.search(this.state.searchInput)}>
                                                        GO
                                                    </button>
                                                </div>
                                            </div>
